...
export const formFields: FormField[] = [
  ...
  { key: "oshiMember", label: "推しメン", type: "text", placeholder: "例：髙松 瞳" },
  { key: "birthday", label: "誕生日", type: "text", placeholder: "例：5月10日 / 1998line" },
  {
    key: "bloodType",
    label: "血液型",
    type: "select",
    placeholder: "選択してください",
    options: ["A型", "B型", "O型", "AB型", "秘密"]
  },
  ...
  { key: "favoriteCostume", label: "好きな衣装", type: "text", placeholder: "例：歌番組衣装、ツアー衣装など" },
  { key: "startedAt", label: "推し始めた時期", type: "text", placeholder: "例：2024年春ごろ" },
  { key: "nextPlans", label: "参戦予定", type: "textarea", placeholder: "例：6/20 東京、7/4 大阪" },
  {
    key: "ikolovePoint",
    label: "イコラブで好きなところ",
    type: "textarea",
    placeholder: "例：曲、ライブ、関係性、空気感など"
  },
